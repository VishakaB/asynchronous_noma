function [data_user4,data_userB,SBer1,SBer2,SBer3,SBerA,SBer4,SBerB,recdata1200,recdata222,estrecdata3,est4A,estrecdata4,est4B] = ...
    hop3_nopower(est1,est2,est3,estA,code1,code2,code3,codeA,code4,codeB,n,N,d4,...
...
estrecdata4=real(recdata4)>0;
errors_user4(i) = size(find([data_user4- estrecdata4]),2); %Errors for User1
SBer4 = errors_user4/N;      
%----------------BER of Data UserA-----------------------------------------
recdata4B=(data_equilizedB'*code4')';
est4B=real(recdata4B)>0;
errors_user4B(i) = size(find([data_userB- est4B]),2); %Errors for User1
SBerB = errors_user4B/N; 
end
