...
propber_1(transmit_snrdb)  = mean(avgavgavg_ber_1);
propber_2(transmit_snrdb)  = mean(avgavgavg_ber_2);
propber_3(transmit_snrdb)  = mean(avgavgavg_ber_3);

user_1(transmit_snrdb)  = mean(user_near);
user_2(transmit_snrdb)  = mean(user_middle);
user_3(transmit_snrdb)  = mean(user_far);

user_1c(transmit_snrdb)  = mean(user_conv_near);
user_2c(transmit_snrdb)  = mean(user_conv_middle);
user_3c(transmit_snrdb)  = mean(user_conv_far);
...
figure (3)
semilogy(transmit_snrdb_vec ,smooth(user_1),'bo-','LineWidth',1)
hold on 
semilogy(transmit_snrdb_vec ,smooth(user_2),'rs-','LineWidth',1)
hold on
semilogy(transmit_snrdb_vec ,smooth(user_3),'k*-','LineWidth',1)
hold on 
semilogy(transmit_snrdb_vec ,smooth(user_1c),'mo--','LineWidth',1)
hold on 
semilogy(transmit_snrdb_vec ,smooth(user_2c),'rs--','LineWidth',1)
hold on
semilogy(transmit_snrdb_vec ,smooth(user_3c),'k*--','LineWidth',1)
grid on
