...
walsh=hadamard(n);              
code1=walsh(4,:);                   %Taking 2nd row of walsh code for User1
...
p1=0.5;                                       % Power of Tap1
p2=0.5;                                     % Power of Tap2
p3=0.5;                                     % Power of Tap3
p4=0.5;
...
hold on;
semilogy(snr,SBer1,'gd-','LineWidth',2);%far 
hold on;
semilogy(snr,SBer2,'kd--','LineWidth',2);%near
axis([0 20 10^-6 1]);
set(gca,'fontsize',14) % say...default here is 10
grid on
legend('Theoratical BER for BPSK on Rician Channel (Urban)' ,'Simulated BER for User1 - hop 1','Simulated BER for User2 - hop 1','FontSize', 14);
