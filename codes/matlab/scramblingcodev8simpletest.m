...
%----------------equilization of the channel-------------------------------
channel_response=fft([gain1;gain2;gain3;gain4],n);
data_equilized1=fft_data_received.*conj(channel_response);
%----------------BER of Data User1-----------------------------------------
recdata110=(data_equilized1'*code1')';
...
%----------------BER of Data User2-----------------------------------------
recdata21=(data_equilized1'*code2')';
...
recdata22=real(recdata21)>0;
errors_user222(i) = size(find([data_user2- recdata22]),2); %Errors for User1
SBer222 = errors_user222/M;                               % simulated ber user2

recdata31=(data_equilized3'*code3')';
recdata33=real(recdata31)>0;
errors_user333(i) = size(find([data_user3- recdata33]),2); %Errors for User1
