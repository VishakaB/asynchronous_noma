...
timeoffset_vec = linspace(1,3,5);
u = 1;%initiate u
nbiter = 3;

for time_offset = 1: length(timeoffset_vec )
K = 3;
...
avgavgpber_1(time_offset) = mean(avg_pber_1);
avgavgpber_2(time_offset) = mean(avg_pber_2);
avgavgpber_3(time_offset) = mean(avg_pber_3);

avgavgber_1(time_offset) = mean(avg_ber_1);
avgavgber_2(time_offset) = mean(avg_ber_2);
avgavgber_3(time_offset) = mean(avg_ber_3);
...
figure (4)
semilogy(timeoffset_vec,smooth(avgavgpber_1),'bo-','LineWidth',1)
hold on 
semilogy(timeoffset_vec,smooth(avgavgber_1),'bo--','LineWidth',2)
hold on
semilogy(timeoffset_vec,smooth(avgavgpber_2),'rs-','LineWidth',1)
hold on 
semilogy(timeoffset_vec,smooth(avgavgber_2),'rs--','LineWidth',2)
hold on 
semilogy(timeoffset_vec,smooth(avgavgpber_3),'k+-','LineWidth',1)
hold on 
semilogy(timeoffset_vec,smooth(avgavgber_3),'k+--','LineWidth',2)
grid on;