...
receivedpowerratio_vec = linspace(1,3,5);
u = 1;%initiate u
nbiter = 3;

for indx = 1: length(receivedpowerratio_vec )
K = 3;
...
receive_pow_ratio = receivedpowerratio_vec(indx);
%change here
for d = 2: K
...
avgavgpber_1(indx) = mean(avg_pber_1);
avgavgpber_2(indx) = mean(avg_pber_2);
avgavgpber_3(indx) = mean(avg_pber_3);

avgavgber_1(indx) = mean(avg_ber_1);
avgavgber_2(indx) = mean(avg_ber_2);
avgavgber_3(indx) = mean(avg_ber_3);
...
figure (4)
semilogy(receivedpowerratio_vec,smooth(avgavgpber_1),'bo-','LineWidth',1)
hold on 
semilogy(receivedpowerratio_vec,smooth(avgavgber_1),'bo--','LineWidth',2)
hold on
semilogy(receivedpowerratio_vec,smooth(avgavgpber_2),'rs-','LineWidth',1)
hold on 
semilogy(receivedpowerratio_vec,smooth(avgavgber_2),'rs--','LineWidth',2)
hold on 
semilogy(receivedpowerratio_vec,smooth(avgavgpber_3),'k+-','LineWidth',1)
hold on 
semilogy(receivedpowerratio_vec,smooth(avgavgber_3),'k+--','LineWidth',2)
grid on;