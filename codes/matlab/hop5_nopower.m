function [data_user6,data_userD,SBer1h5,SBer2h5,SBer3h5,SBerAh5,SBer4h5,SBerBh5,...
    ...
    est6h5,estDh5]= ...
    hop5_nopower(est1h4,est2h4,est3h4,estAh4,est4h4,estBh4,est5h4,estCh4,code1,code2,code3,codeA,...
...
recdata6h5=(data_equilized5'*code6')';
est6h5=real(recdata6h5)>0;
errors_user6h5(i) = size(find([data_user6- est6h5]),2); %Errors for User1
SBer6h5 = errors_user6h5/N;  

recdataDh5=(data_equilizedD'*code6')';
estDh5=real(recdataDh5)>0;
errors_userDh5(i) = size(find([data_userD- estDh5]),2); %Errors for User1
SBerDh5 = errors_userDh5/N;                               % simulated ber user1
