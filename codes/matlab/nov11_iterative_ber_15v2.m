...
avg_ber_1(j) = mean(ber_1);%meann ber of each step
...
user_near(i) = ber_1(1);
user_middle(i) = ber_2(1);
user_far(i) = ber_3(end);
...
figure (2)
semilogy(1:5,smooth(user_1),'bo-','LineWidth',2)
hold on 
semilogy(1:5,smooth(user_2),'rs-','LineWidth',2)
hold on
semilogy(1:5,smooth(user_3),'k*-','LineWidth',2)

figure (3)
semilogy(1:length(iter_K_vec)-1,smooth(smooth(avgavgavg_ber_1(1:end-1))),'bo-','LineWidth',2)
hold on 
semilogy(1:length(iter_K_vec)-1,smooth(smooth(avgavgavg_ber_2(1:end-1))),'rs-','LineWidth',2)
hold on
semilogy(1:length(iter_K_vec)-1,smooth(smooth(avgavgavg_ber_3(1:end-1))),'k*-','LineWidth',2)
hold on
semilogy(1:length(iter_K_vec)-1,smooth(smooth(avgavgavg_ber_1(end))*ones(length(iter_K_vec)-1,1)),'bo--','LineWidth',1)
hold on 
semilogy(1:length(iter_K_vec)-1,smooth(smooth(avgavgavg_ber_2(end))*ones(length(iter_K_vec)-1,1)),'rs--','LineWidth',1)
hold on
semilogy(1:length(iter_K_vec)-1,smooth(smooth(avgavgavg_ber_3(end))*ones(length(iter_K_vec)-1,1)),'k*--','LineWidth',1)
