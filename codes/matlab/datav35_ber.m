...
%testing complexity results: ber vs receive ratio
clc;
clear all;
close all;
...
function [a,b,c,d,e,f,g,h,i,j,r,s,weakestconv,weakestprop,intermconv,intermprop] = seqsic(initialK,alldatadecoded,K,priority,power_vec,sym_dur_vec,...
