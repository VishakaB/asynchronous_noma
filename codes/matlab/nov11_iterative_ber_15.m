...
k_vec = linspace(1,3,3);
u = 1;%initiate u
nbiter = 100;

iter_K_vec = [5;4;4;2;15];
...
convber_1 = avgavgavg_ber_1(end)*ones(length(iter_K_vec)-1,1);
convber_2 = avgavgavg_ber_2(end)*ones(length(iter_K_vec)-1,1);
convber_3 = avgavgavg_ber_3(end)*ones(length(iter_K_vec)-1,1);

figure (1)
semilogy(1:length(iter_K_vec)-1,smooth(avgavgavg_ber_1(1:end-1)),'bo-','LineWidth',2)
hold on 
semilogy(1:length(iter_K_vec)-1,smooth(avgavgavg_ber_2(1:end-1)),'rs-','LineWidth',2)
hold on
semilogy(1:length(iter_K_vec)-1,smooth(avgavgavg_ber_3(1:end-1)),'k*-','LineWidth',2)
hold on
semilogy(1:length(iter_K_vec)-1,smooth(convber_1),'bo--','LineWidth',2)
hold on
semilogy(1:length(iter_K_vec)-1,smooth(convber_2),'rs--','LineWidth',2)
hold on
semilogy(1:length(iter_K_vec)-1,smooth(convber_3),'k*--','LineWidth',2)