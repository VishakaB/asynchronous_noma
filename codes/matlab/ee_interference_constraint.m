...
interf_vec =linspace(10,120,10);%change here
mpriority = 20;
...
receive_pow_ratio_vec = [5];
receive_pow_ratio =1;
pr_vec = [0.5;1;1.5;2;2.5;3;3.5;4;4.5;5;5.5;6;6.5;7.5;8;8.5;10;12;15;20];

for indx = 1:length(pr_vec)
    
K = 10;
initialK = 10;
receive_pow_ratio = receive_pow_ratio_vec(1);
pr_vec(indx);
[EEconv(indx),EEprop(indx),z(indx),zz(indx),e(indx),f(indx),g(indx),...
    ...
    pr_vec(indx),N,receive_pow_ratio_vec,receive_pow_ratio);
    strongconv;
    strongprop;
    intermconv;
    intermprop;
...
cvx_begin quiet
   ...
   subject to
      ...
      gan: decision_uk'*sumsym_dur_vec-...
